...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->çàêðûòüÏðèëîæåíèåToolStripMenuItem->Click += gcnew System::EventHandler(this, &Form2::çàêðûòüÏðèëîæåíèåToolStripMenuItem_Click);
			// 
			...
			this->íàçàäToolStripMenuItem->ToolTipText = L"Âîçâðàò ê âûáîðó ôàéëîâ";
			...
			this->ñåññèèToolStripMenuItem->ToolTipText = L"Îòêðûòèå ñåññèé";
			...
			this->toolStripComboBox1->ToolTipText = L"Íîìåð ñòðàíèöû";
